...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر ليندا
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("اوامري") and event.query.user_id == jmub.uid:
            buttons = [
                [Button.inline("معلومات ليندا", data="AOMRDB")],
                [
                ...
                [
                    ...
                    Button.inline(" الفارات", data="VARELA_V1"),
                ],
            ]
...
@jmub.tgbot.on(CallbackQuery(data=re.compile(rb"VARELA_V1")))
@check_owner
async def varssett(event):
    await event.edit(
...
async def varssett(event):
    await event.edit(
        ...
        buttons=[
            ...
            [Button.inline("رجوع", data="VARELA_V1")],
            [Button.inline("القائمة الرئيسية", data="MAIN")],
        ],
    )
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس ليندا هذه بعض المعلومات عن ليندا:

- سورس ليندا يمتلك اكثر من 100 أمر 
- ليندا هو افضل سورس عربي يتميز بالحماية

قناة الكلايش:  @JJOTT
قناة الملاحظات: @RRRDF
قناة السورس: @ELA_V1
قناة المساعدة: @ELA_V1_HELP
مجموعة المساعدة: @ELA_V1_SUPPORT""",
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
