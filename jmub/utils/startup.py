...
LOGS = logging.getLogger("اعداد ليندا")
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await jmub.send_message(
                "@jmthon_bot",
                "تم بنجاح تشغيل سورس ليندا عزيزي المستخدم هذا البوت سيتم تشغيله قريبا بعد اكماله",
            )
            await asyncio.sleep(1)
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_file(
                    ...
                    caption="**شكرا لتنصيبك سورس ليندا**\n • هنا بعض الملاحظات التي يجب ان تعرفها عن استخدامك لسورس ليندا.",
        ...
        try:
            if BOTLOG:
                await jmub.tgbot.send_message(
                    BOTLOG_CHATID,
                    "**لقد تم بنجاح تنصيب سورس ليندا **\n➖➖➖➖➖➖➖➖➖➖\n**السورس**: @ELA_V1\n**المطور**: @devpokemon\n➖➖➖➖➖➖➖➖➖➖\n**مجموعة الدعم**: @ELA_V1\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        (Button.url(" المساعدة", "https://t.me/ELA_V1"),)
                    ],
                )
        except Exception as e:
            LOGS.error(e)
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كروب بوت ليندا", jmub, Config.TG_BOT_USERNAME, descript, photobt
        )
